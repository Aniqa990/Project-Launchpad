      ...
      data.forEach((message: Message) => {
        ...
        if (!conversationMap.has(otherUserId)) {
          conversationMap.set(otherUserId, {
            userId: otherUserId,
            userName: `User ${otherUserId}`, // In real app, fetch user details
            lastMessage: message.messageContent,
            lastMessageTime: message.timestamp,
            unreadCount: message.senderId !== currentUserId && !message.isRead ? 1 : 0,
            avatar: `https://images.pexels.com/photos/${1000 + otherUserId}/pexels-photo-${1000 + otherUserId}.jpeg?auto=compress&cs=tinysrgb&w=400`
          });
        } else {
