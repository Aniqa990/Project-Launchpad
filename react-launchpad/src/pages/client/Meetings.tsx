...
export default function Meetings() {
  ...
  const handleStartRecording = async () => {
    ...
    try {
      ...
      mediaRecorder.start();
      setRecording(true);
      // Redirect to Google Meet as soon as recording starts
  ...
  return (
    <div className="p-8 max-w-xl mx-auto text-center">
      ...
      <p className="mt-4 text-gray-500 text-sm">
        This will record audio using your microphone, open Google Meet in a new tab, and let you download the file.
      </p>
    </div>
  );
} 