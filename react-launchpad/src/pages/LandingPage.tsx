          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/signup?feature=features" className="text-gray-400 hover:text-white transition-colors">Features</Link></li>
                <li><Link to="/signup?feature=pricing" className="text-gray-400 hover:text-white transition-colors">Pricing</Link></li>
                <li><Link to="/signup?feature=integrations" className="text-gray-400 hover:text-white transition-colors">Integrations</Link></li>
                <li><Link to="/signup?feature=api" className="text-gray-400 hover:text-white transition-colors">API</Link></li>
              </ul>
            </div>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {selectedFeature.detailedInfo.howItWorks.map((step, index) => (
